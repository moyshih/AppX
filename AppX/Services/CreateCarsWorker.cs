...
{
    public class CreateCarsWorker : BackgroundService
    {
        private readonly ConfigData _configData;
        private readonly IMessagesService _messagesService;
        private IModel _channel;

        public CreateCarsWorker(IMessagesService messagesService, ConfigData configData)
        {
        ...
        private Vehicle getRandomVehicle(Random rnd, IEnumerable<KnownColor> colorNames)
        {
            ...
            Vehicle vehicle = new Car(type, color, plateNumber, timestamp);
